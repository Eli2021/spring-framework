...
/**
 * Default implementation of the {@link NamespaceHandlerResolver} interface. Resolves namespace URIs to implementation
 * classes based on the mappings contained in mapping file.
 *
 * <p>By default, this implementation looks for the mapping file at
 * {@code META-INF/spring.handlers}, but this can be changed using the {@link #DefaultNamespaceHandlerResolver(ClassLoader,
 * String)} constructor.
 *
 * @author Rob Harrop
...
public class DefaultNamespaceHandlerResolver implements NamespaceHandlerResolver {
	...
	public NamespaceHandler resolve(String namespaceUri) {
		...
		if (handlerOrClassName == null) {
			...
			/* NamespaceHandler 已经做过解析, 直接取出转换 */
		...
		if (handlerMappings == null) {
			synchronized (this) {
				...
				if (handlerMappings == null) {
					...
					try {
						/**
						 * handlerMappingsLocation 构造函数初始化为 {@link DEFAULT_HANDLER_MAPPINGS_LOCATION} META-INF/spring.handlers
						 */
						Properties mappings =
