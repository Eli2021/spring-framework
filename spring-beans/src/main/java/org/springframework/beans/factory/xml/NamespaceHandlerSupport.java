...
/**
 * Support class for implementing custom {@link NamespaceHandler NamespaceHandlers}. Parsing and decorating of
 * individual {@link Node Nodes} is done via {@link BeanDefinitionParser} and {@link BeanDefinitionDecorator} strategy
 * interfaces, respectively.
 *
 * <p>Provides the {@link #registerBeanDefinitionParser} and {@link #registerBeanDefinitionDecorator}
 * methods for registering a {@link BeanDefinitionParser} or {@link BeanDefinitionDecorator} to handle a specific
 * element.
 *
 * @author Rob Harrop
...
public abstract class NamespaceHandlerSupport implements NamespaceHandler {
	...
	/**
	 * Stores the {@link BeanDefinitionDecorator} implementations keyed by the local name of the {@link Attr Attrs} they
	 * handle.
	 */
