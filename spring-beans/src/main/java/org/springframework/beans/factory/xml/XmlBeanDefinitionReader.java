 ...
 * The document reader will register each bean definition with the given bean factory, talking to the latter's
 * implementation of the {@link org.springframework.beans.factory.support.BeanDefinitionRegistry} interface.
 *
...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
	 ...
	 * If you are switching validation off for schema files, you might need to activate schema namespace support
	 ...
	 * which exhibits fail fast behaviour. External tools can provide an alternative implementation that collates errors
	 * and warnings for display in the tool UI.
	 */
	 ...
	 * External tools can provide an alternative implementation to monitor the components being registered in the
	 * BeanFactory.
	 */
	 ...
	 * as the source object. This means that - during normal runtime execution - no additional source metadata is
	 * attached to the bean configuration metadata.
	 */
	 ...
	 * logs warnings using the logger instance of the view class, and rethrows errors to discontinue the XML
	 * transformation.
	 *
	 ...
	 * Load bean definitions from the specified XML file.
	 *
	 * @param encodedResource the resource descriptor for the XML file, allowing to specify an encoding to use for
	 *                        parsing the file
	 * @return the number of bean definitions found
	 * @throws BeanDefinitionStoreException in case of loading or parsing errors
	 */
